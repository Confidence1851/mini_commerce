                    ...
                    <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                        <thead>
                            <tr>
                                ...
                                <th class="">Active</th>
                                <th class="">Show on Dashboard</th>
                                <th class="">Accessible</th>
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>{{ $boolOptions[$category->is_active] }} </td>
                                    <td>{{ $boolOptions[$category->show_on_dashboard] }} </td>
                                    <td>{{ $category->accessible_plans }}</td>
                                    <td class="text-center">
