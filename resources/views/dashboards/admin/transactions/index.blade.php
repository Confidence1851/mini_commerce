                ...
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $sn++ }}</td>
                            <td>
                                <a href="{{ route('admin.users.show', $transaction->user_id) }}" class="text-primary">
                                    ...
                                    <li class="mb-3">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" onclick="return confirm('Are you sure of the action?')" href="{{ route('admin.transaction_status', ['id' => $transaction->id, 'status' => $status]) }}">
