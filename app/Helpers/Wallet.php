...
class Wallet
{
    ...
    public static function credit(
        ...
        if (!in_array($walletAccount, Constants::WALLET_TYPES)) {
            throw new Exception("Invalid wallet type" , Constants::ERROR_CODE);
        }
    ...
    public static function debit(
        ...
        if ($updateWallet) {
            ...
            if ($debitAmount < 0) {
                throw new Exception("Insuffient balance in $accountName wallet" , Constants::ERROR_CODE);
            }
    ...
    public static function transfer(
        ...
        if ($amount > $accountBalance) {
                throw new Exception("Amount is greater than balance" , Constants::ERROR_CODE);
        }
